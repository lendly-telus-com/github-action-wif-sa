...
# module "gcloud_build_batch_logs_test_artifacts" {
#   source                 = "terraform-google-modules/gcloud/google"
#   version                = "~> 2.0"
#   create_cmd_entrypoint  = "gcloud"
#   create_cmd_body        = "builds submit ../batch_logs --tag=${local.test_artifact}:${data.archive_file.demo.output_sha} --project=${var.project_id} --gcs-log-dir=gs://tf-cloud-build-gh-logs"
#   destroy_cmd_entrypoint = "gcloud"
#   destroy_cmd_body       = "container images delete ${local.test_artifact}:${data.archive_file.demo.output_sha} --quiet"
# }
...
#     metadata {
#       annotations = {
#         "client.knative.dev/user-image"        = "${local.test_artifact}:${data.archive_file.demo.output_sha}"
...
#     spec {
#       containers {
#         image = "${local.test_artifact}:${data.archive_file.demo.output_sha}"
#         env {
#           name  = "project-name"
