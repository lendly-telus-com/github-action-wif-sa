...
#   name                        = "${var.project_id}-function-source-cf"
#   location                    = var.region
#   uniform_bucket_level_access = true
# }

# resource "google_storage_bucket" "trigger_bucket_cf" {
#   name     = "batch-gh-log-audit-cf"
#   location = var.region
#   uniform_bucket_level_access = true
# }
...
#     event_filters {
#       attribute = "bucket"
#       value     = google_storage_bucket.trigger_bucket_cf.name
#     }
#   }
# }
